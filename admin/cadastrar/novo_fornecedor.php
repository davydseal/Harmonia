...
<H3 class=module-title>Fornecedores Cadastrados</H3>
<DIV class="module-content flexcroll">
<TABLE class=adminlist>

<TBODY>
<TR>
    <TD class=title><STRONG>Contato</STRONG> </TD>
...
<TR>
<TD><a href="../consultar/consultar_fornecedor.php?codigo_adm=<?php print($variavel['codigo']); ?>" class="modal" rel="{handler: &#39;iframe&#39;, size: {x: 750, y: 500}}"><?php print($variavel['contato']); ?></a></TD>
...
<DIV class=module-3>
<DIV class=module-4>
<H3 class=module-title>Cadastrar Fornecedores</H3>
<DIV class="module-content ">
<form name="f" action="novo_fornecedor2.php" method ="post">
      ...
      <tr>
      <td>CNPJ</td><td><input type="text" size="3" name="c_cnpj1" maxlength="2" onKeyUp="cnpj1();">-<input type="text" size="3" name="c_cnpj2" maxlength="3" onKeyUp="cnpj2();">-<input type="text" size="3" name="c_cnpj3" maxlength="3" onKeyUp="cnpj3();">-<input type="text" size="3" name="c_cnpj4" maxlength="4" onKeyUp="cnpj4();">-<input type="text" size="3" name="c_cnpj5" maxlength="2" onKeyUp="cnpj5();"></td>
      </tr>

      <tr>
      <td>Insc. estadual</td><td><input type="text" size="20" name="c_inscest"></td>
      </tr>

        <tr>
      <td>Insc. municipal</td><td><input type="text" size="20" name="c_inscmun"></td>
      </tr>
    ...
    <tr>
      <td>Cep</td><td><input type="text" size="20" name="c_cep"></td>
      </tr>
    ...
    <tr>
      <td>Pessoa para contato</td><td><input type="text" size="20" name="c_contato"></td>
      </tr>
    ...
    <tr>
      <td>Email</td><td><input type="text" size="20" name="c_email"></td>
          ...
          <tr>
      <td>Site</td><td><input type="text" size="20" name="c_site"></td>
      </tr>
...
<TR>
    <TD colSpan=2>
      ...
      <SPAN class=quickadd_key>
      <LABEL class=key for=published>Razão social</LABEL>
      </SPAN>
      </DIV></TD>
      </TR>
<TR>
    <TD colSpan=2>
      <DIV id=quickadd_textarea><!-- Start Editor --><TEXTAREA style="WIDTH: 96%; HEIGHT: 150px" rows="30" cols="50" name="c_texto"></TEXTAREA></DIV>
</TD>
</TR>
