...
<LI><A class=ArticleTrash href="../consultar/empresa.php"><SPAN class=component-image></SPAN>Produtos</A></LI>
...
<H3 class=module-title>Foto do administrador</H3>
...
<center><IMG title="<?php print($vetor_foto['nickname']); ?>" src="../../img/<?php print($vetor_foto['foto']); ?>" width="250" height="250"></center>
...
<DIV class="module-content ">
        ...
        $ver_foto = "SELECT * FROM $table_harlogins WHERE codigo=$codigo";
...
<BR><BR>
<form name="a" action="mudarfoto2.php" method="post" enctype="multipart/form-data">
<A href="#" ><IMG title="<?php print($vetor_foto['nickname']); ?>" src="../../img/<?php print($vetor_ver_foto['foto']); ?>" width="150" height="100"></A></LI>
