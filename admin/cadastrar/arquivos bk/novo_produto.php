...
activitylogPro = {baseRoute: "http://ap3.adminpraise.com/administrator/" }
	...
	form.c_custof.value = (form.c_preco.value*1) + (form.c_impostos.value*1) + (form.c_frete.value*1) + (form.c_embalagem.value*1) * (form.c_imposto.value + 100)/100)
    ...
    function formulaCustoFinal()
    {
      if(form.c_preco.value != "" && form.c_impostos.value != "" && form.c_frete.value != "" && form.c_embalagem.value != "" && form.c_imposto.options[form.c_imposto.selectedIndex].value){
        form.c_custof.value = parseFloat(form.c_preco.value) +
...
<form name="form" action="novo_produto2.php" method ="post">
     ...
     <select name="c_bdi">
      ...
      <td>Rateio BDI</td><td><input type="text" size="50" name="c_impostos" value="<?php if($qtdProdutos > 0){print($vetor['custo'] / $qtdProdutos); }?>" readonly></td>
             ...
             <tr>
      <td>Frete compra</td><td><input type="text" size="50" name="c_frete" onkeyup="formulaCustoFinal()"></td>
      </tr>
 ...
 <tr>
     ...
     <select name="c_imposto">
            ...
            ?>
      <option value="<?php print($vetor['custo']);?>"><?php print($vetor['custo']);?></option>
        <?php
            }
            }
            ?>
      ...
      <option value="<?php print($vetor['codigo']);?>"><?php print($vetor['custo']);?></option>
        <?php
            ...
            ?>
             ...
             <tr>
      <td>Custo de venda</td><td><input type="text" size="50" name="c_custov" readonly></td>
      </tr>
      
             <tr>
      <td>Preço de venda</td><td><input type="text" size="50" name="c_venda" readonly></td>
      </tr>
