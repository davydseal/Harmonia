...
<TD><?php print($variavel['enviador']); ?></TD>
...
<form name="news" action="news2.php" method="post">
<TABLE class="quickAddTable admintable">
  ...
  <TR class=quickadd_title_alias>
    <TD colSpan=2><SPAN class=quickadd_title><LABEL class=key for=title>Descricao
