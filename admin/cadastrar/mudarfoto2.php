...
$foto_antiga = "SELECT * FROM $table_harlogins WHERE codigo=$codigo";
...
$update_prima = "UPDATE $table_harlogins SET prima=1 WHERE codigo=$codigo";
...
$atualizar = "UPDATE $table_harlogins  SET foto='$shuffled.jpg' WHERE codigo=$codigo";
