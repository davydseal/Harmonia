...
<H3 class=module-title>Atualizar produtos</H3>
...
<form name="news" action="produtos_harmonia_exclusiva.php" method="post">
<TABLE class="quickAddTable admintable">
  ...
  <TR class=quickadd_title_alias>
    <TD colSpan=2><SPAN class=quickadd_title><LABEL class=key for=title>Codigo do produto:
      </LABEL><input type="text" size="55" name="c_codigo2" maxlength="20"> </SPAN></TD><TAG></TAG></TR>
