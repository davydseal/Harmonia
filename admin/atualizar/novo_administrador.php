...
<H3 class=module-title>Atualizar Administradores</H3>
...
<TR>
 <TD><a href="novo_administrador2.php?codigo_adm=<?php print($variavel['codigo']); ?>" class="modal" rel="{handler: &#39;iframe&#39;, size: {x: 400, y: 270}}"><?php print($variavel['nickname']); ?></A></TD>
