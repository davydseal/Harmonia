...
<H3 class=module-title>Excluir News Usuarios</H3>
...
<?php
             require("../../ligar.php");
            $consulta3 = "SELECT * FROM $table_harnoticia WHERE tipo=1 order by codigo";
...
<TR>
<TD><a href="excluir_news.php?codigo_news=<?php print($variavel['codigo']); ?>" class="modal" rel="{handler: &#39;iframe&#39;, size: {x: 400, y: 220}}"><?php print($variavel['assunto']); ?></a></TD>
