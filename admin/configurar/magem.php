...
<H3 class=module-title>Configurar magem de lucro</H3>
...
<?php
             require("../../ligar.php");
            $consulta3 = "SELECT * FROM $table_harmagem";
...
<TR>
<TD><a href="magem2.php?codigo=<?php print($variavel['codigo']); ?>" class="modal" rel="{handler: &#39;iframe&#39;, size: {x: 400, y: 170}}"><?php print($variavel['custo']); ?></a></TD>
