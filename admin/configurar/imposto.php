...
<LI><A class=ArchivedArticles href="produtos_harmonia.php"><SPAN class=component-image></SPAN>Produtos</A></LI>
<LI><A class=ArticleTrash href="#"><SPAN class=component-image></SPAN>News</A>
<ul>
...
<li><a href="bdi.php">Custo BDI</a></li>
<li><a href="imposto.php">Imposto simples</a></li>
<li><a href="magem.php">Magem de lucro</a></li>
</ul></LI>
...
<H3 class=module-title>Configurar imposto simples</H3>
<DIV class="module-content flexcroll">
<TABLE class=adminlist>

<TBODY>
<TR>
    <TD class=title><STRONG>Numero</STRONG> </TD>
    <TD class=title><STRONG>Status</STRONG> </TD>
</TR>

<?php
             require("../../ligar.php");
            $consulta3 = "SELECT * FROM $table_harimposto";
...
<TR>
<TD><a href="imposto2.php?codigo=<?php print($variavel['codigo']); ?>" class="modal" rel="{handler: &#39;iframe&#39;, size: {x: 400, y: 170}}"><?php print($variavel['custo']); ?></a></TD>
<TD><?php print($variavel['status']); ?></TD>
 <?php
 }
 ?>
</TR>
...
<TABLE class="quickAddTable admintable">
  ...
  <TR class=quickadd_title_alias>
    <TD colSpan=2><SPAN class=quickadd_title><LABEL class=key for=title>Nome
      </LABEL><input type="text" size="55" name="c_Nome" maxlength="20"> </SPAN></TD><TAG></TAG></TR>
