...
<H3 class=module-title>Configurar custo BDI</H3>
...
<?php
             require("../../ligar.php");
            $consulta3 = "SELECT * FROM $table_harbdi";
...
<TR>
<TD><a href="bdi2.php?codigo=<?php print($variavel['codigo']); ?>" class="modal" rel="{handler: &#39;iframe&#39;, size: {x: 400, y: 170}}"><?php print($variavel['custo']); ?></a></TD>
