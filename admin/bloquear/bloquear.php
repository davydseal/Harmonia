...
<LI><A class=ArticleTrash href="bloquear.php"><SPAN class=component-image></SPAN>Bloquear</A></LI>
...
<H3 class=module-title>Contas Desbloqueadas</H3>
...
<TR>
    ...
    <TD class=title><STRONG>Nickname</STRONG> </TD>
    <TD class=title><STRONG>Status</STRONG> </TD>
</TR>

<?php
             require("../../ligar.php");
            $consulta3 = "SELECT * FROM $table_harlogins WHERE situacao=1 && status!=1";
...
<TR>
<TD><a href="bloquear2.php?codigo=<?php print($variavel['codigo']); ?>&temp=1" class="modal" rel="{handler: &#39;iframe&#39;, size: {x: 500, y: 70}}"><?php print($variavel['codigo']); ?></a></TD>
<TD><a href="bloquear2.php?codigo=<?php print($variavel['codigo']); ?>&temp=1" class="modal" rel="{handler: &#39;iframe&#39;, size: {x: 500, y: 70}}"><?php print($variavel['nickname']); ?></a></TD>
<TD>
<?php
...
<DIV class=module-3>
<DIV class=module-4>
<H3 class=module-title>Contas Bloqueadas</H3>
...
<?php
             require("../../ligar.php");
            $consulta3 = "SELECT * FROM $table_harlogins WHERE situacao=2";
            $resultado3 = mysql_query($consulta3);
            $quantos_forum = mysql_num_rows($resultado3);
            ...
            {
            ?>
            <td colspan="3"><center><b><i>Nao existe conta bloquiada no momento!</td>
            <?php
            }
...
<TR>
<TD><a href="bloquear2.php?codigo=<?php print($variavel['codigo']); ?>&temp=2" class="modal" rel="{handler: &#39;iframe&#39;, size: {x: 500, y: 70}}"><?php print($variavel['codigo']); ?></a></TD>
<TD><a href="bloquear2.php?codigo=<?php print($variavel['codigo']); ?>&temp=2" class="modal" rel="{handler: &#39;iframe&#39;, size: {x: 500, y: 70}}"><?php print($variavel['nickname']); ?></a></TD>
<TD>
<?php
