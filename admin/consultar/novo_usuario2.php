...
<H3 class=module-title>Consultar Usuarios</H3>
...
<?php
            ...
            $consulta3 = "SELECT * FROM $table_harlogins WHERE nickname='$c_nickname' && status=2";
            $resultado3 = mysql_query($consulta3);
            $quantos_forum = mysql_num_rows($resultado3);
            $variavel = mysql_fetch_array($resultado3);

            $consulta4 = "SELECT * FROM $table_harlogins WHERE status=2";
