...
<H3 class=module-title>Consultar Administradores</H3>
...
<?php
            ...
            $consulta3 = "SELECT * FROM $table_harlogins WHERE nickname='$c_nickname' && status=1";
            $resultado3 = mysql_query($consulta3);
            $quantos_forum = mysql_num_rows($resultado3);
            $variavel = mysql_fetch_array($resultado3);

            $consulta4 = "SELECT * FROM $table_harlogins WHERE status=1";
            $resultado4 = mysql_query($consulta4);
            $quantos_forum4 = mysql_num_rows($resultado4);
            ...
            alert("Administrador Inexistente!");
            ...
            for($j=0;$j < $quantos_forum4;$j++)
            {
            $variavel4 = mysql_fetch_array($resultado4);
            if($j >= 15)
            {
            break;
            }
...
<TR>
<TD><a href="consultar_adm.php?codigo_adm=<?php print($variavel4['codigo']); ?>" class="modal" rel="{handler: &#39;iframe&#39;, size: {x: 750, y: 500}}"><?php print($variavel4['nickname']); ?></a></TD>
<TD><?php print($variavel4['codigo']); ?></TD>
 <?php
 }
 ?>
</TR>
...
<TABLE class="quickAddTable admintable">
  ...
  <TR class=quickadd_title_alias>
    <TD colSpan=2><SPAN class=quickadd_title><LABEL class=key for=title>Login :
      </LABEL><?php print($c_nickname); ?> </SPAN></TD><TAG></TAG></TR>
...
else if($variavel[3] == 2)
{
?>
Usuario
<?php
}
else if($variavel[3] == 3)
{
?>
Empresa
<?php
...
{
?>
<font color="green">Desbloqueado</font>
<?php
}
else if($variavel[4] == 2)
{
?>
...
{
?>
<font color="orange">Desconhecido</font>
<?php
}
?>
</tr>
