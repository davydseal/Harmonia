...
<?php
  ...
  ?>
<H3 class=module-title>Consultar noticias de usuarios</H3>
...
<?php
            ...
            $consulta3 = "SELECT * FROM $table_harnoticia WHERE tipo=1 order by codigo desc";
            $resultado3 = mysql_query($consulta3);
            $quantos_forum = mysql_num_rows($resultado3);

            $consulta4 = "SELECT * FROM $table_harnoticia WHERE assunto='$c_assunto' && tipo=1";
...
<TR>
<TD><a href="news_usuario.php?codigo_news=<?php print($variavel['codigo']); ?>" class="modal" rel="{handler: &#39;iframe&#39;, size: {x: 750, y: 346}}"><?php print($variavel['assunto']); ?></a></TD>
