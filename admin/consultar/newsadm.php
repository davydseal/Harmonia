...
<H3 class=module-title>Consultar noticias de administradores</H3>
...
<TD><a href="consultar_adm.php?codigo_adm=<?php print($variavel2['codigo']); ?>" class="modal" rel="{handler: &#39;iframe&#39;, size: {x: 750, y: 500}}"><?php print($variavel['enviador']); ?></a></TD>
 <?php
 }
 ?>
</TR>
...
<form name="news" action="newsadm2.php" method="post">
<TABLE class="quickAddTable admintable">
  ...
  <TR class=quickadd_title_alias>
    <TD colSpan=2><SPAN class=quickadd_title><LABEL class=key for=title>Assunto
      </LABEL><input type="text" size="55" name="c_assunto"> </SPAN></TD><TAG></TAG></TR>
