...
<LI><A class=ArticleTrash href="empresa.php"><SPAN class=component-image></SPAN>Produtos</A></LI>
...
<?php
  ...
  ?>
<H3 class=module-title>Consultar noticias administradoras</H3>
<DIV class="module-content flexcroll">
<TABLE class=adminlist>

<TBODY>
<TR>
    <TD class=title><STRONG>Assunto</STRONG> </TD>
...
<?php
            ...
            $consulta4 = "SELECT * FROM $table_harnoticia WHERE assunto='$c_assunto' && tipo=3";
            $resultado4 = mysql_query($consulta4);
            $quantos_foru4 = mysql_num_rows($resultado4);
            $v = mysql_fetch_array($resultado4);

            if($quantos_foru4 == 0)
            {
            ?>
            <script language="javascript">
            alert("Esta noticia nao foi encontrada!");
            document.location.href="newsadm.php";
            </script>
            <?php
            }
...
<TR>
<TD><a href="news_adm.php?codigo_news=<?php print($variavel['codigo']); ?>" class="modal" rel="{handler: &#39;iframe&#39;, size: {x: 750, y: 346}}"><?php print($variavel['assunto']); ?></a></TD>
...
<DIV class=module-3>
<DIV class=module-4>
<H3 class=module-title>Dados da Noticia</H3>
<DIV class="module-content ">
<form name="news" action="novo_administrador2.php" method="post">
<TABLE class="quickAddTable admintable">
  ...
  <TR class=quickadd_title_alias>
    <TD colSpan=2><SPAN class=quickadd_title><LABEL class=key for=title>Assunto:
      </LABEL><font color="black"><b><?php print($c_assunto); ?> </SPAN></TD><TAG></TAG></TR>
...
<TR class=quickadd_title_alias>
<td><font color="black"><b><center>Texto</td>
</tr>
<TR class=quickadd_title_alias>
<td><center><?php print($v['texto']); ?></td>
</tr>
</TBODY>
</TABLE>
</FORM>
...
<TABLE class=adminlist>
  ...
  <TR>
    <TD><a href="consultar_adm.php?codigo_adm=<?php print($variavel['codigo']); ?>" class="modal" rel="{handler: &#39;iframe&#39;, size: {x: 750, y: 500}}"><?php print($variavel['nickname']); ?></A></TD>
    <TD><?php print($variavel['situacao']); ?></TD>
    <?php
 }
 ?>
...
<TR>
<TD><a href="consultar_fornecedor2.php?codigo_adm=<?php print($variavel['codigo']); ?>" class="modal" rel="{handler: &#39;iframe&#39;, size: {x: 750, y: 500}}"><?php print($variavel['contato']); ?></a></TD>
